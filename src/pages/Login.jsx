  ...
  return (
    ...
    >
      ...
      <div className="relative backdrop-blur-xl bg-white/20 border border-white/30 p-6 rounded-2xl w-80 shadow-2xl text-white transition-all duration-300">
        ...
        <input
          className="border-b border-white/50 bg-transparent p-2 w-full mb-4 outline-none placeholder-white"
          placeholder="User ID"
        ...
        <select
          className="border border-white/50 bg-transparent p-2 w-full mb-4 rounded text-white"
        ...
        <button
          className={`w-full py-2 rounded-lg ${
            loading
              ...
              : "bg-blue-900/80 hover:bg-blue-900"
          }`}
          onClick={handleLogin}
          disabled={loading}
        >
